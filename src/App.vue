        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            <li class="nav-small-cap">
              <Icon icon="solar:menu-dots-linear" class="nav-small-cap-icon fs-4"></Icon>
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link " href="javascript:void(0)">
                <Icon icon="solar:bell-linear" class="fs-6"></Icon>
                    ...
                    <div class="card-body">
                      <div class="d-flex align-items-center gap-6 mb-4 pb-3">
                        <span
                          ...
                          <Icon icon="solar:football-outline" class="fs-6 text-secondary"> </Icon>
                        </span>
                    ...
                    <div class="card-body">
                      <div class="d-flex align-items-center gap-6 mb-4">
                        <span
                          ...
                          <Icon icon="solar:box-linear" class="fs-6 text-danger"></Icon>
                        </span>

...
async function deleteInterest() {
  ...
  console.log("delete!!!!!!", `http://localhost:8080/where-is-my-home/interest/delete/${props.info.id}`);
  console.log('props.info.id:', props.info.id); // props.info.id 값을 확인
  ...
  <li class="sidebar-item mb-3 me-3 pe-3">
    ...
    <div class="row bg-gray p-3" style="background-color: white">
      <div class="col-5 d-flex">
        <a class="" href="#" @click="goToDetail">
          <img v-if="info.img1 != '@/assets/images/no-image.jpeg'" class="rounded w-100 align-middle" :src="info.img1"
            alt="prd1" />
